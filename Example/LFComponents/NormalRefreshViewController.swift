...
class NormalRefreshViewController: UIViewController, RefreshShowable {
    
    private let reuseIdentifier = "normal.showcase"
    ...
    override func viewDidLoad() {
        ...
        title = "Ring Refreshing"
        tableView.lfc.addRefreshHeader(style: tintStyle, size: iconSize, target: self, selector: #selector(refreshHeaderEvent))
        tableView.lfc.addRefreshFooter(style: tintStyle, size: iconSize, target: self, selector: #selector(refreshFooterEvent))
...
extension NormalRefreshViewController: UITableViewDelegate, UITableViewDataSource {
